        ...
        <section id="contact" ref={sectionRef} style={{ position: 'relative', padding: 'clamp(60px, 8vw, 100px) 0', overflow: 'hidden', background: 'var(--parchment)', width: '100%' }}>
            ...
            <div style={{ position: 'relative', zIndex: 10, maxWidth: '1280px', margin: '0 auto', padding: '0 32px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px,1fr))', gap: '40px', alignItems: 'start' }}>
                    <div className="reveal-left" style={{ padding: '44px 40px', background: 'var(--cream)', border: '1px solid rgba(181,149,86,0.25)', boxShadow: '0 20px 60px rgba(21,12,7,0.08)', position: 'relative' }}>
                        <div style={{ position: 'absolute', top: 0, left: 0, width: '26px', height: '26px', borderTop: '1.5px solid rgba(181,149,86,0.6)', borderLeft: '1.5px solid rgba(181,149,86,0.6)' }} />
                        <div style={{ position: 'absolute', bottom: 0, right: 0, width: '26px', height: '26px', borderBottom: '1.5px solid rgba(181,149,86,0.6)', borderRight: '1.5px solid rgba(181,149,86,0.6)' }} />
                        <h3 style={{ fontFamily: "'Manrope',sans-serif", fontWeight: 700, fontSize: '0.78rem', color: 'var(--gold)', marginBottom: '28px', letterSpacing: '0.2em', textTransform: 'uppercase' }}>പൂജകൾ തിരഞ്ഞെടുക്കുക</h3>
                        
                        <select
                            value={poojaType} onChange={e => setPoojaType(e.target.value)}
                            style={{ width: '100%', marginBottom: '20px', padding: '16px', background: 'var(--cream)', border: '1px solid rgba(181,149,86,0.3)', borderRadius: '4px', fontSize: '0.95rem', color: 'var(--text-dark)', fontFamily: "'Manrope',sans-serif", outline: 'none', appearance: 'none' }}
                        >
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '22px' }}>
                        <div className="reveal-right" style={{ padding: '38px 34px', background: 'var(--cream)', border: '1px solid rgba(181,149,86,0.25)', boxShadow: '0 20px 60px rgba(21,12,7,0.08)', position: 'relative' }}>
                            <div style={{ position: 'absolute', top: 0, left: 0, width: '26px', height: '26px', borderTop: '1.5px solid rgba(181,149,86,0.6)', borderLeft: '1.5px solid rgba(181,149,86,0.6)' }} />
                            <div style={{ position: 'absolute', bottom: 0, right: 0, width: '26px', height: '26px', borderBottom: '1.5px solid rgba(181,149,86,0.6)', borderRight: '1.5px solid rgba(181,149,86,0.6)' }} />
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '26px' }}>
                                {[
                                    ...
                                    <a key={item.label} href={item.href} className="contact-row" target={item.href.startsWith('http') ? '_blank' : undefined} rel="noopener noreferrer"
                                        ...
                                        <div style={{ width: '40px', height: '40px', flexShrink: 0, background: 'rgba(181,149,86,0.08)', border: '1px solid rgba(181,149,86,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--gold)' }}>
                                            {item.icon}
                                        </div>
                                        <div>
                                            <p style={{ fontFamily: "'Manrope',sans-serif", fontWeight: 600, fontSize: '0.6rem', letterSpacing: '0.3em', textTransform: 'uppercase', color: 'rgba(53,34,22,0.5)', marginBottom: '3px' }}>{item.label}</p>
                                            <p style={{ fontFamily: "'Manrope',sans-serif", fontWeight: 500, fontSize: '0.87rem', color: 'var(--text-dark)' }}>{item.value}</p>
                                        </div>
                                    </a>
                                ))}
                            </div>
                        ...
                        <div className="reveal-right" style={{ padding: '34px', textAlign: 'center', background: 'linear-gradient(135deg, rgba(181,149,86,0.06) 0%, rgba(243,233,210,0.8) 100%)', border: '1px solid rgba(181,149,86,0.22)' }}>
                            <span style={{ fontSize: '2rem', display: 'block', marginBottom: '12px', filter: 'drop-shadow(0 0 14px rgba(181,149,86,0.7))', animation: 'flicker 3s ease-in-out infinite' }}>🪔</span>
                            ...
                            <p style={{ fontFamily: "'Noto Serif Malayalam',serif", fontStyle: 'italic', fontSize: '0.76rem', color: 'var(--gold)', marginTop: '14px' }}>
                                — ജയരാജൻ നമ്പൂതിരി
                            </p>
                        </div>
                    </div>
