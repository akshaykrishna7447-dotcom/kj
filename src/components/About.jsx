...
export default function About() {
    ...
    return (
        <section id="about" style={{ position: 'relative', padding: '120px 0', background: 'var(--parchment)', overflow: 'hidden' }}>
            ...
            <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '2px', background: 'linear-gradient(90deg, transparent, rgba(181,149,86,0.4), transparent)' }} />
            ...
            <div style={{ position: 'relative', zIndex: 10, maxWidth: '1280px', margin: '0 auto', padding: '0 32px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px,1fr))', gap: '64px', alignItems: 'start' }}>
                    ...
                    <div className="reveal-left">
                        <div style={{ position: 'relative', border: '1px solid var(--gold-border)', boxShadow: '0 20px 60px rgba(21,12,7,0.12)' }}>
                            ...
                            {[[12,null,12,null],[12,null,null,12],[null,12,12,null],[null,12,null,12]].map(([t,b,l,r],i) => (
                                <div key={i} style={{
                                    ...
                                    borderTop:    t !== null && (l !== null || r !== null) ? '1.5px solid var(--gold-border-hi)' : 'none',
                                    borderLeft:   l !== null ? '1.5px solid var(--gold-border-hi)' : 'none',
                                    borderRight:  r !== null ? '1.5px solid var(--gold-border-hi)' : 'none',
                                    borderBottom: b !== null ? '1.5px solid var(--gold-border-hi)' : 'none',
                                }} />
                            ))}
                        </div>
                        <div style={{ padding: '22px', marginTop: '14px', textAlign: 'center', background: 'var(--cream)', border: '1px solid var(--gold-border)' }}>
                            <p style={{ fontFamily: "'Noto Serif Malayalam',serif", fontStyle: 'italic', fontSize: '1.15rem', color: 'var(--gold)', marginBottom: '6px' }}>
                                "യത്ര വിദ്യാ തത്ര ദേവാഃ"
                            </p>
                            <p style={{ fontFamily: "'Manrope',sans-serif", fontWeight: 500, fontSize: '0.65rem', letterSpacing: '0.25em', color: 'var(--brown-mid)', opacity: 0.8, textTransform: 'uppercase' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '36px' }}>
                        ...
                        <div className="reveal-up">
                            <h3 style={{ fontFamily: "'Manrope',sans-serif", fontWeight: 700, fontSize: '0.78rem', color: 'var(--gold-border-hi)', marginBottom: '18px', letterSpacing: '0.2em', textTransform: 'uppercase' }}>പൂജാകർമ്മങ്ങളിലെ വൈദഗ്ദ്ധ്യം</h3>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                                {['Ganapathi Homam','Sudarshana Homam','Bhagavathy Pooja','Navagraha Pooja','Satyanarayana Katha','Ayushya Homam','Mrityunjaya Homam','Lakshmi Kubera Pooja'].map(r => (
                                    <div key={r} style={{ padding: '10px 14px', fontSize: '0.82rem', fontFamily: "'Manrope',sans-serif", fontWeight: 500, color: 'var(--brown-rich)', display: 'flex', alignItems: 'center', gap: '10px', background: 'var(--cream)', border: '1px solid var(--gold-subtle)' }}>
                                        <span style={{ color: 'var(--gold)', fontSize: '0.8rem' }}>✦</span>{r}
                                    </div>
                                ))}
                            </div>
                        </div>
